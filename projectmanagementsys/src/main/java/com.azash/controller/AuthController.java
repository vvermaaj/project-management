...
import com.azash.config.JwtProvider;
import com.azash.model.User;
import com.azash.repository.UserRepository;
import com.azash.request.LoginRequest;
import com.azash.response.AuthResponse;
import com.azash.service.CustomUserDetailsImpl;
...
public class AuthController {
    ...
    public ResponseEntity<AuthResponse> signing(@RequestBody LoginRequest loginRequest){
        ...
        AuthResponse res = new AuthResponse();
        res.setMessage("signing in success");
        res.setJwt(jwt);
